# Asset Manager Module Specification

Document ID: MOD-000006  
Version: 0.1.0  
Status: Draft  
Owner: Aurora Labs  
Repository: aurora-spec  
Path: 03-Modules/MOD-000006_ASSET_MANAGER_SPEC.md  
...
The Asset Manager module exists to manage project assets, references and generated media relationships without taking ownership of creative meaning owned by AFL modules.
...
- Import asset references into a project
- Track asset identity and metadata
- Classify assets by approved asset type rules
- Maintain relationships between assets and Scenes, Shots, Characters or Symbols
- Validate required reference asset availability
- Preserve offline access to local asset references where technically possible
- Emit asset lifecycle events
...
- Editing image or video content
- AI generation implementation
- Scene meaning ownership
- Shot meaning ownership
- Character identity design
- Prompt export implementation
- GUI asset browser rendering
...
The Asset Manager module defines a controlled responsibility boundary inside Aurora.
