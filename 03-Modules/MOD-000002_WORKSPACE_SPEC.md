# Workspace Module Specification

Document ID: MOD-000002  
Version: 0.1.0  
Status: Draft  
Owner: Aurora Labs  
Repository: aurora-spec  
Path: 03-Modules/MOD-000002_WORKSPACE_SPEC.md  
...
The Workspace module exists to represent the active working context of Aurora Studio after a project is opened.
...
- Track active selection context
- Coordinate active Scene, Shot, Asset and Timeline context references
- Expose workspace state through approved interfaces
- Avoid owning domain data that belongs to other modules
- Support offline workspace operations
- Provide state needed by UI without becoming UI implementation
...
- Workspace-level UI-independent state references
...
The Workspace module defines a controlled responsibility boundary inside Aurora.
