# Project Manager Module Specification

Document ID: MOD-000001  
Version: 0.1.0  
Status: Draft  
Owner: Aurora Labs  
Repository: aurora-spec  
Path: 03-Modules/MOD-000001_PROJECT_MANAGER_SPEC.md  
...
The Project Manager module exists to manage Aurora project lifecycle, including project creation, opening, saving, closing, validation and recovery coordination.
...
- Create new Aurora projects from approved project structure rules
- Open existing Aurora projects
- Coordinate project save operations
- Coordinate project close operations
- Validate basic project structure before use
- Preserve project identity and metadata
- Coordinate recovery behavior when project state is incomplete or damaged
- Emit project lifecycle events through approved interfaces
...
- Asset Manager
- Timeline Manager
- Plugin Manager only through approved interfaces
...
The Project Manager module defines a controlled responsibility boundary inside Aurora.
