# Character Manager Module Specification

Document ID: MOD-000007  
Version: 0.1.0  
Status: Draft  
Owner: Aurora Labs  
Repository: aurora-spec  
Path: 03-Modules/MOD-000007_CHARACTER_MANAGER_SPEC.md  
...
The Character Manager module exists to manage character identity, references and continuity requirements across Scenes and Shots.
...
- Create and manage character identity records
- Track character reference assets
- Provide character identity references to Scene and Shot managers
- Support Character Presence relationships without owning Scene-specific meaning
- Maintain character continuity requirements
- Validate required character references before export when needed
- Emit character lifecycle events
...
- Scene-specific Character Presence ownership
- Performance generation
- Face generation or face swap implementation
- Provider-specific reference handling
- GUI character editor rendering
...
- Scene Manager
- Shot Manager
- Prompt Export Manager through approved interface
...
The Character Manager module defines a controlled responsibility boundary inside Aurora.
