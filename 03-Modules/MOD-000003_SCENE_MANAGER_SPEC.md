# Scene Manager Module Specification

Document ID: MOD-000003  
Version: 0.1.0  
Status: Draft  
Owner: Aurora Labs  
Repository: aurora-spec  
Path: 03-Modules/MOD-000003_SCENE_MANAGER_SPEC.md  
...
The Scene Manager module exists to manage AFL Scene units inside an Aurora project according to the AFL Scene Model.
...
- Create Scene records according to approved AFL Scene specifications
- Update Scene metadata and conceptual sections
- Delete, archive or restore Scenes through approved lifecycle rules
- Maintain Scene ordering or grouping references where applicable
- Validate Scene completeness before shot breakdown or export
- Coordinate Scene relationships with Shots, Characters, Symbols and Timeline through approved interfaces
...
- Full Shot data ownership
- Character database ownership
- Timeline editing implementation
- Prompt export implementation
- Provider-specific generation
- GUI Scene panel rendering
...
- Scene state
- Scene-level references to approved AFL concepts
...
The Scene Manager module defines a controlled responsibility boundary inside Aurora.
