# Shot Manager Module Specification

Document ID: MOD-000004  
Version: 0.1.0  
Status: Draft  
Owner: Aurora Labs  
Repository: aurora-spec  
Path: 03-Modules/MOD-000004_SHOT_MANAGER_SPEC.md  
...
The Shot Manager module exists to manage AFL Shot units inside Scenes according to the AFL Shot Model.
...
- Create Shot records inside parent Scenes
- Update Shot conceptual sections
- Maintain Shot ordering inside Scenes
- Validate Shot completeness before export
- Coordinate Shot relationships with Scene, Character Presence, Camera, Composition, Motion and Prompt Export Intent
- Support Shot variants conceptually when future specifications approve them
...
- Shot title or label
- Shot ordering reference
- Shot purpose
- Shot state
- Shot-level AFL concept references
...
The Shot Manager module defines a controlled responsibility boundary inside Aurora.
